			...
			if (sender instanceof Player)
			{
				if (args.length == 0) 
				{
					sender.sendMessage(ChatColor.GOLD + "Choose from the following ranks:\n"
							...
							+ ChatColor.WHITE + "Ender: " + ChatColor.DARK_PURPLE + "Endermite, Enderman," + ChatColor.DARK_RED + " EnderDragon\n"
