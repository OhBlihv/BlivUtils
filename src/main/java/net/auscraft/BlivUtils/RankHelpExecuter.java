				...
				if (args.length > 0)
				{
					...
					else if (args[0].equalsIgnoreCase("Mooshroom")) 
					{
						sender.sendMessage(ChatColor.YELLOW	+ "----- " + ChatColor.GOLD + "AusCraft Rank Help" + ChatColor.YELLOW + " -----\n"
								...
								+ ChatColor.WHITE + " http://wiki.aus-craft.net/ranks#Mooshroom < Click Me!");
						return true;
					}
					...
					{
						sender.sendMessage(ChatColor.YELLOW	+ "----- " + ChatColor.GOLD + "AusCraft Rank Help" + ChatColor.YELLOW + " -----\n"
								+ ChatColor.DARK_GREEN + "MagmaSlime: " + ChatColor.GRAY
								+ "$25,000 ingame (/buyrank MagmaSlime)\n"
								...
								+ ChatColor.DARK_GREEN + "More Info:"
								+ ChatColor.WHITE + " http://wiki.aus-craft.net/ranks#MagmaSlime < Click Me!");
						return true;
					}
					else if (args[0].equalsIgnoreCase("Blaze"))
					{
						sender.sendMessage(ChatColor.YELLOW	+ "----- " + ChatColor.GOLD + "AusCraft Rank Help" + ChatColor.YELLOW + " -----\n"
								...
								+ ChatColor.DARK_GREEN + "More Info:"
								+ ChatColor.WHITE + " http://wiki.aus-craft.net/ranks#Blaze < Click Me!");
						return true;
					} 
					...
					else if (args[0].equalsIgnoreCase("Enderman"))
					{
						sender.sendMessage(ChatColor.YELLOW	+ "----- " + ChatColor.GOLD + "AusCraft Rank Help" + ChatColor.YELLOW + " -----\n"
								...
								+ ChatColor.DARK_GREEN + "More Info:" + ChatColor.WHITE
								+ " http://wiki.aus-craft.net/ranks#Enderman < Click Me!");
						return true;
					} 
